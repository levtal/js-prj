//https://www.dyclassroom.com/jquery/jquery-traversal-methods
...
$(function(){
	 ...
	 * 		  ...
	 ...
	 // 5.30 https://www.dyclassroom.com/jquery/jquery-traversal-methods
	var text = $("p").eq(2).text();	// index 2 means we are selecting the 3rd para
	console.log(text);

	var text2 = $("p").eq(3).text();
	console.log(text2);
	*/ 
 ...
 /*
	...
	console.log("elmens",elems);
	console.log("Number of descendents: " + elems.length);
	 
	 
	var elems = $("#fruits-2").find("li");
	console.log("Number of descendents 2: " + elems.length);
